...
complete shred history, clients shoudl query `summary.query_shreds`.
...
```json
{
	...
	"key": "shreds",
	"value": {
        "slots": [289245044, 289245044],
        "shred_idx": [1234, null],
        "event": ["repair_request", "slot_complete"],
        "event_ts": ["1739657041588242791", "1739657041788244791"]
    }
}
```
