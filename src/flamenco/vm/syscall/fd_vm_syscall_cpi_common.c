...
https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1067-L1132
...
VM_SYCALL_CPI_UPDATE_CALLEE_ACC_FUNC( fd_vm_t *                          vm,
  ...
  /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1087-L1089 */
  ...
  /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1091-L1113 */
  if( vm->stricter_abi_and_runtime_constraints ) {
    ...
    /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1094-L1109 */
    if( FD_UNLIKELY( prev_len!=post_len ) ) {
      ulong address_space_reserved_for_account = caller_account->orig_data_len; /* TODO: is this always set correctly? */
      if( !vm->is_deprecated ) {
        address_space_reserved_for_account = fd_ulong_sat_add( address_space_reserved_for_account, MAX_PERMITTED_DATA_INCREASE );
      }

      /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1103-L1105 */
    ...
    /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1110-L1112 */
    int err;
    ...
    /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1114-L1121 */
    int err;
    if( fd_borrowed_account_can_data_be_resized( &callee_acc, caller_account->serialized_data_len, &err ) &&
      ...
      /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1116 */
      err = fd_borrowed_account_set_data_from_slice( &callee_acc, caller_account->serialized_data, caller_account->serialized_data_len );
      if( FD_UNLIKELY( err ) ) {
        FD_VM_ERR_FOR_LOG_INSTR( vm, err );
        return -1;
      ...
      /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1117-L1119 */
      FD_VM_ERR_FOR_LOG_INSTR( vm, err );
      return -1;
    }
  }

  /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1124-L1129 */
  ...
  for( ulong i=0UL; i<instruction_accounts_cnt; i++ ) {
    ...
    for( ushort j=0; j<account_infos_length && !found; j++ ) {
      ...
      /* The following implements the checks in from_account_info which
         ...
         https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L850-L861
       */
      ////// BEGIN from_account_info

      fd_vm_acc_region_meta_t * acc_region_meta = &vm->acc_region_metas[index_in_caller];
      /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L138 */
      if( FD_LIKELY( vm->stricter_abi_and_runtime_constraints ) ) {
        /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L139-L144 */
        ...
        /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L145-L150 */
      ...
      /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L155-L175 */
      VM_SYSCALL_CPI_ACC_INFO_LAMPORTS_VADDR( vm, (account_infos + j), lamports_vaddr );
      /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L162-L173  */
      if( FD_LIKELY( vm->stricter_abi_and_runtime_constraints ) ) {
        /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L163-L165
           Check that the account's lamports Rc<RefCell<&mut u64>> is not stored in the
           account region. Because a refcell is only present if the Rust SDK is used, we
        ...
        /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L167-L172 */
      ...
      /* Rust ABI: https://github.com/anza-xyz/agave/blob/v3.0.4/syscalls/src/cpi.rs#L224-L230
         ...
         TODO: factor out into get_serialized_data function to mimic Agave
       */
...
VM_SYSCALL_CPI_UPDATE_CALLER_ACC_FUNC( fd_vm_t *                          vm,
  ...
  /* Update the caller account lamports with the value from the callee
     https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1191 */
  *(caller_account->lamports) = fd_txn_account_get_lamports( callee_acc );
  ...
  /* Update the caller account owner with the value from the callee
     https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1192 */
  ...
  /* Update the caller account data with the value from the callee
     https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1194-L1195 */
  ulong prev_len = *caller_account->ref_to_len_in_vm;
  ulong post_len = fd_txn_account_get_data_len( callee_acc );

  /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1197-L1204 */
  ulong address_space_reserved_for_account = caller_account->orig_data_len;
  ...
  /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1206-L1216 */
  ...
  /* https://github.com/anza-xyz/agave/blob/v3.0.1/syscalls/src/cpi.rs#L1254-L1265 */
  if( !(vm->stricter_abi_and_runtime_constraints && vm->direct_mapping) ) {
...
VM_SYSCALL_CPI_ENTRYPOINT( void *  _vm,
  ...
  /* Check that the account info pointers are not inside the input region, to prevent callers
     writing to the account region.
  ...
  *_ret = instr_exec_res;
  ...
  /* Update the caller account regions with any changes made by the callee during CPI execution
